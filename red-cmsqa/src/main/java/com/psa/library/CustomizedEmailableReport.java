...
public class CustomizedEmailableReport implements IReporter  {
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
		...
		File eReportC=new File(outdir, "customized-emailable-report.html" );
    ...
    private void generateForResult(ITestResult ans, ITestNGMethod method,
        ...
        if (hasReporterOutput || hasThrowable) {
            ...
            if (hasReporterOutput) {
                if (hasThrowable) {
                    out.println("<h3>Test Screenshots</h3>");
                }
                for (String line : msgs) {
                    out.println(line + "<br/>");
                }
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        ...
        tableColumnStart("# OF PASSED TESTCASES");
        //tableColumnStart("Scenarios<br/>Passed");
        tableColumnStart("# OF SKIPPED TESTCASES");
        tableColumnStart("# OF FAILED TESTCASES");
    ...
    protected void endHtml(PrintWriter out) {
        out.println("<center> QA TEAM TESTNG-REPORTS </center>");
        out.println("</body></html>");
    }

    // ~ Inner Classes --------------------------------------------------------
    /** Arranges methods by classname and method name */
    private class TestSorter implements Comparator<IInvokedMethod> { // Comparable<T> , Comparator<IInvokedMethod>
        // ~ Methods
        // -------------------------------------------------------------
        ...
        public int compare(IInvokedMethod o1, IInvokedMethod o2) {
            ...
            if (r == 0) {
                ...
                //r=o1.getTestResult().compareTo((ITestResult) o2.getTestMethod());
